  ...
  <div className="pt-32 min-h-screen bg-white">
     <div className="max-w-6xl mx-auto px-4 mb-20 text-center">
      <RevealOnScroll>
        ...
        <h1 className="font-display font-bold text-5xl md:text-7xl mb-6 text-primary">How We Work</h1>
    ...
    <div className="py-24 px-4 text-center">
        <h2 className="font-display font-bold text-3xl mb-8">Ready to start your journey?</h2>
