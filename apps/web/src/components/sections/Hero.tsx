...
export const Hero = () => {
  return (
    <section className="pt-40 pb-20 px-4 flex flex-col items-center justify-center text-center relative overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-center">
        ...
        <RevealOnScroll delay={200}>
          <h1 className="font-display font-bold text-5xl md:text-7xl lg:text-[80px] leading-[1.1] text-primary mb-8 tracking-tight">
        ...
        <RevealOnScroll delay={600}>
          <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto justify-center">
            <Link to="/contact"><Button className="w-full sm:w-auto">Start A Project <ArrowRight size={18} /></Button></Link>
            <Link to="/case-studies"><Button variant="secondary" className="w-full sm:w-auto">View Our Work</Button></Link>
          </div>
        </RevealOnScroll>
      </div>
